...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_fa0c47fde31ea3cb40611306ba15e674e091686add249f952f5d4a30d5f94a48');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Eduweb/TrainingBundle/Resources/views'), 'EduwebTraining');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5f6d863a7e2e58.18444448')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EduwebTrainingBundle' => 'Eduweb\\TrainingBundle\\EduwebTrainingBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'EduwebTrainingBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Eduweb/TrainingBundle'),
            ...
            'appapikey' => 'fijofihsdfliusDHDFcjbewiu',
            'locale' => 'en',
